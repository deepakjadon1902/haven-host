      ...
      <div className="flex items-center justify-between mb-5">
        ...
        <div className="flex gap-2">
          <button
            ...
            className="grid h-9 w-9 place-items-center rounded-lg border border-border hover:border-gold hover:text-gold transition"
        ...
        {grid.map((cell, i) => {
          ...
          return (
            <motion.button
              ...
              className={`flex aspect-square flex-col rounded-lg border p-1.5 text-left transition md:p-2 ${cls} ${
