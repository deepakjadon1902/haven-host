    ...
    <div className="min-h-screen bg-background text-foreground grid lg:grid-cols-2">
      ...
      <div className="relative hidden lg:flex flex-col justify-between p-12 overflow-hidden">
        ...
        <div className="relative z-10 text-xs text-white/45">
          © {new Date().getFullYear()} Haven Host Collection
        </div>
      </div>
...
export const authInputCls =
  "w-full bg-white/[0.04] border border-white/10 rounded-lg px-4 h-12 text-sm font-medium outline-none focus:border-gold/60 focus:bg-white/[0.06] transition placeholder:text-white/35";
