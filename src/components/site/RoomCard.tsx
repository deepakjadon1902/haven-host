      ...
      >
        ...
        <div className="p-6">
          ...
          <div className="mt-3 flex flex-wrap items-center gap-3 text-xs text-muted-foreground">
            {room.bedType && (
              <span className="flex items-center gap-1.5"><Bed className="h-3.5 w-3.5 text-gold" /> {room.bedType}</span>
            )}
            <span className="flex items-center gap-1.5"><Users className="h-3.5 w-3.5 text-gold" /> Up to {room.maxAdults}</span>
          </div>
